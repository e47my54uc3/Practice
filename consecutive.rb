def Consecutive(arr)
  ...
  top_val = arr.sort.last
  start = arr.sort.first
  
  total_dif = top_val - start
  int_req = (total_dif - 1) - (arr.length - 2)
...
4 to 8. Negative numbers may be entered as parameters and no array will have
